...
php_client_dir=$root_dir/api/clients/php
...
for file in $protos_dir/*.proto; do
    ...
    $protoExec --proto_path=$protos_dir --php_out=$php_client_dir --grpc_out=$php_client_dir --plugin=protoc-gen-grpc=$grpc_php_plugin $file
    echo "\t\033[0;32m[DONE]\033[39;49;0m\n"
done

#Archive files generated by php grpc。
mv $php_client_dir/GPBMetadata $php_client_dir/App/Grpc/
